...
class MenuFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding.junkfoodButton.setOnClickListener{view: View ->
            view.findNavController().navigate(MenuFragmentDirections.actionMenuFragmentToCustomizedMenuFragment("junkfood"))

        }

        binding.drinksButton.setOnClickListener{view: View ->
        view.findNavController().navigate(MenuFragmentDirections.actionMenuFragmentToCustomizedMenuFragment("drinks"))}
        return binding.root
    }
